...
//        showDilogue(contex);
  ...
  getAddress(double lat , double long)async{
    ...
    setState(() {
      ...
      var address=first.subLocality.toString()+ " "+first.subAdminArea.toString()+" "+first.featureName.toString()+" "+first.thoroughfare.toString();
                  ...
                  // displays the index of the current item.
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          sliderlist!=null? sliderlist.length>0? Container(
                              color: AppColors.white,
                              height: 170.0,

                              child: sliderlist!=null?sliderlist.length>0 ?
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        if (!sliderlist[index].title.isEmpty) {
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => Screen2(sliderlist[index].title, "")),);
                                        }
                                        else
                                        if (!sliderlist[index].description
                                            .isEmpty) {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
...
//                              color: AppColors.white,
                          ...
                          topProducts!=null?  topProducts.length>0? Container(
                            color: AppColors.white,
                            padding: EdgeInsets.only(bottom: 10),
                            child: Row(
                              ...
                              children: <Widget>[
                                Padding(
                                  padding: EdgeInsets.only(
                                      top: 8.0, left: 8.0, right: 8.0),
                                  child: Text(Constant.AProduct_type_Name1,
                                    style: TextStyle(
                                        color: AppColors.product_title_name,
                                        fontSize: 15,
                                        fontFamily: 'Roboto',
                                  ...
                                  ElevatedButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => ProductList("Top", Constant.AProduct_type_Name1),
                                        ),
                                      );
                                    },
                                  ),
...
//                            color: AppColors.black,
                            ...
                            child: topProducts!= null ? Container(
//                              color: AppColors.tela,
...
//                                            width: 162,
                                                        ...
                                                        child: topProducts[index].img!=null?Image.network(Constant
                                                            .Product_Imageurl +
...
//                                                  =="no-cover.png"? getImage(topProducts[index].productIs):topProducts[index].image,
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text('\u{20B9} ${calDiscount(topProducts[index].buyPrice,topProducts[index].discount)} ${topProducts[index].unit_type!=null?"/"+topProducts[index].unit_type:""}', style: TextStyle(
                          ...
                          topProducts1!=null?topProducts1.length>0? Container(
                            color: AppColors.white,
                            padding: EdgeInsets.only(bottom: 10),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  ...
                                  ElevatedButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => ProductList("day", "Deals of the day"),
                                        ),
                                      );
                                    },
                                    child: Text('View All'),
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Padding(
                                                          padding: const EdgeInsets.only(top: 2.0, bottom: 1),
                                                          child: Text('\u{20B9} ${calDiscount(topProducts1[index].buyPrice,topProducts1[index].discount)} ${topProducts1[index].unit_type!=null?"/"+topProducts1[index].unit_type:""}', style: TextStyle(
                                                              color: AppColors.green,
                                                              fontWeight: FontWeight.w700,fontSize: 12
                                                          )),
                                                        ),
...
//
                          ...
                          bannerSlider!=null? bannerSlider.length>0? Container(
                            padding: EdgeInsets.only(bottom:10),
                            color: AppColors.tela1,
...
//
                                      ...
                                      child: Container(
                                          padding: EdgeInsets.only(
                                              ...
                                              right: 8.0,
                                              bottom: 5),
                                          child:Image.network(Constant.Product_Imageurl5 + bannerSlider[index].img,
                                            fit: BoxFit.fill,)
                          ...
                          dilofdayProducts!=null?  dilofdayProducts.length>0?  Container(
                            color: Colors.white,
                            padding: EdgeInsets.only(bottom: 10),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
...
//
                                                ...
                                                child:  SizedBox(
                                                  ...
                                                  child: dilofdayProducts[index].img!=null?Image.network(Constant.Product_Imageurl5 + dilofdayProducts[index].img,
                                                    fit: BoxFit.fill,)
/*
                                                  CachedNetworkImage(
                                                    fit: BoxFit.cover,
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: Text('\u{20B9} ${calDiscount(dilofdayProducts[index].buyPrice,dilofdayProducts[index].discount)} ${dilofdayProducts[index].unit_type!=null?"/"+dilofdayProducts[index].unit_type:""}', style: TextStyle(
                                                              color: AppColors.green,
                                                              fontWeight: FontWeight.w700,fontSize: 12
                                                          )),
                                                        ),
