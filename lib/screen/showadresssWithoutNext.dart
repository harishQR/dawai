...
import 'package:royalmart/screen/updateAddressNew.dart';

import 'AddAddress.dart';
import 'UpdateAddress.dart';

class ShowAddressNew extends StatefulWidget {
  final String valu;
  const ShowAddressNew(this.valu) : super();
  @override
  _ShowAddressState createState() => _ShowAddressState();
}

class _ShowAddressState extends State<ShowAddressNew> {
          ...
          Container(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                primary: AppColors.telamoredeep,
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          UpDateAddressNew(add[index], widget.valu),
                    ),
                  );
                },
//              splashColor: AppColors.tela,
...
//                add.removeAt(index);
  ...
  Future _deleteAdderss(String id, int index) async {
    ...
    final response = await http
        .post(Constant.base_url + 'manage/api/user_address/delete/', body: map);
