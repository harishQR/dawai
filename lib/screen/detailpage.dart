...
import 'package:royalmart/model/aminities_model.dart';
...
//  Note note ;
  ...
  Future<void> getAmenities() async {
    await DatabaseHelper.getAmenities(widget.plist.productIs).then((value) {
                        ...
                        children: map<Widget>(imgList1, (index, url) {
                          return Padding(
                            ...
                            child: Container(
                              ...
                              child: Divider(
                                height: 20,
                                color: _current == index ? AppColors.tela : AppColors.darkGray,
                      ...
                      Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Padding(
                              padding: const EdgeInsets.only(top: 2.0, left: 10, bottom: 1),
...
//                                                        totalmrp=mrp * _count;
                                  ...
                                  Padding(
                                    padding: EdgeInsets.only(top: 0.0, left: 10.0, right: 8.0),
                                    child: Center(
                                      child: Text('$_count',
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    child: ListView.builder(
                                        ...
                                        itemCount: amenitiesModel.data.customFieldsValue.length,
                                        itemBuilder: (context, index) {
                                          final name = amenitiesModel.data.customFieldsValue[index].fieldsName;
                                          final value = amenitiesModel.data.customFieldsValue[index].fieldValue;
                                          final key = name.substring(0, name.indexOf(',')).replaceAll("_", " ");

                                          print("amenitiesModel.data.customFieldsValue.length--> ${amenitiesModel.data.customFieldsValue.length}");
                                          return _amenitiesCard(key: key, value: value);
                                        }),
                                  ),
                                ),
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(left: 16.0, top: 8.0),
                                      child: Text(
                                        widget.plist.returns == "0" ? "No" : widget.plist.returns + "day",
                                        overflow: TextOverflow.fade,
                                        style: new TextStyle(
                                          color: Colors.black,
                                          fontSize: 14.0,
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(left: 16.0, top: 8.0),
                                      child: Text(
                                        widget.plist.cancels == "0" ? "No" : widget.plist.cancels + "day",
                                        overflow: TextOverflow.fade,
                                        style: new TextStyle(
                                          color: Colors.black,
                                          fontSize: 14.0,
                                                          ...
                                                          children: <Widget>[
                                                            group[index].img.length > 2
                                                                ? SizedBox(
                                                                    height: 70,
                                                                    child: Image.network(
                                                                      Constant.Product_Imageurl1 + group[index].img,
                                                                      fit: BoxFit.fill,
                                                                    )
                                                                    /*  CachedNetworkImage(
                                                    fit: BoxFit.cover,
...
//                                                  =="no-cover.png"? getImage(topProducts[index].productIs):topProducts[index].image,
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Padding(
                            padding: EdgeInsets.only(top: 8.0, left: 14.0, right: 8.0),
                            child: Text(
                              'RELATED PRODUCTS',
                              style: TextStyle(color: Colors.black45, fontSize: 13, fontFamily: 'Roboto', fontWeight: FontWeight.bold),
                            ),
                          ),
                          Padding(
                            padding: const EdgeInsets.only(right: 8.0, top: 8.0, left: 5.0),
...
//                                            width: 162,
                                                    ...
                                                    child: topProducts1[index].img != null
                                                        ? Image.network(
                                                            Constant.Product_Imageurl + topProducts1[index].img,
                                                            fit: BoxFit.fill,
                                                          )
                                                        /*  CachedNetworkImage(
                                                        fit: BoxFit.cover,
